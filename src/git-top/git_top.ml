...
module Graph = Git.Object_graph.Make (Digestif.SHA1) (Store)

let pp_index_entry = Git_index.Entry.pp ~pp_oid:Digestif.SHA1.pp
...
let () =
  Logs.set_reporter
    (Logs_fmt.reporter ~dst:Fmt.stderr ~pp_header:Logs_fmt.pp_header ())
