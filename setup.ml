...
(* OASIS_START *)
(* DO NOT EDIT (digest: 940cf1147ab3cfc8a3c2b99f16e71972) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gitMain.ml"});
               Executable
                 ({
                     cs_name = "test_git";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some ">Ã\005\012≠^9tµ\135g\134ÕSÛ‘";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
