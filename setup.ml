...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7e188ed8a59f7d587c1eb9e656905fd4) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Unix libraries";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib/backend/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "git"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Git_memory"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "git";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "git"; InternalLibrary "git-unix"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "git";
                           FindlibPackage ("git.store", None);
                           InternalLibrary "git-fs"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "ogit.ml"});
               Executable
                 ({
                     cs_name = "test_git";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "r³À¾hÚÍ\153õ\017B·)i\t\127";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
