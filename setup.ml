...
(* OASIS_START *)
(* DO NOT EDIT (digest: 09d1c9996e9d1f23f0a1e6d675d0ac12) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Git_http"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "git";
                      lib_findlib_name = Some "http";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("dns.mirage", None);
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("fmt.cli", None);
                           FindlibPackage ("fmt.tty", None);
                           FindlibPackage ("logs.cli", None);
                           FindlibPackage ("logs.fmt", None);
                           FindlibPackage ("mtime.os", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some ")\241q\167T%2~\166\231\005\018)\218\226\176";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
